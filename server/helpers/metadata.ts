...
const parsePinAlias = async (file: string) => {
...
export const extractMcuFromFirmwareConfig = async (filePath: string) => {
...
export const getExtruderRotationDistance = (extruderId: z.infer<(typeof Extruder)['shape']['id']>) => {
