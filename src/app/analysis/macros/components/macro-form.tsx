...
export const MacroForm: React.FC<MacroFormProps> = ({ form, submit }) => {
	...
	return (
		<div className="flex min-h-full w-full flex-col">
			<Form {...form}>
				<header className="sticky top-0 z-10 flex flex-grow-0 items-center gap-1 border-b border-zinc-100/10 bg-zinc-700/25 px-4 py-4 backdrop-blur-sm">
				...
				<ResizablePanelGroup direction="horizontal" className="flex-1">
					<ResizablePanel defaultSize={35} className="p-4" minSize={20}>
						<Reorder.Group
							axis="y"
							as="div"
					...
					<ResizablePanel className="relative mt-[10px] p-4" defaultSize={65} minSize={20}>
						<Card className="min-h-72 w-full">
