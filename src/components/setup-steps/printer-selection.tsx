...
const printers: SelectableCard[] = [
	...
	},
	{
		...
		right: <Image src={basePath + '/img/voron-v24.png'} width={50} height={50} alt="Rat Rig V-Minion" />,
		options: [
			{ name: '250mm', id: '250' },
			{ name: '300mm', id: '300' },
			{ name: '350mm', id: '350' },
	...
	},
	{
		...
		right: <Image src={basePath + '/img/voron-v0.png'} width={50} height={50} alt="Rat Rig V-Minion" />,
	},
	{
		id: 'prusa-mk3s',
		name: 'Prusa MK3s',
		details: 'The classic Prusa i3 MK3s from Prusa Research',
		right: <Image src={basePath + '/img/prusa-mk3s.webp'} width={50} height={50} alt="Rat Rig V-Minion" />,
	},
	{
		id: 'prusa-mini',
		name: 'Prusa Mini',
		details: 'Mini bed slinger from Prusa Research',
		right: <Image src={basePath + '/img/prusa-mini.webp'} width={50} height={50} alt="Rat Rig V-Minion" />,
	},
];
		...
		<>
			<div className="p-8">
				...
				<div className="mb-5 border-b border-gray-200 pb-5">
					<h3 className="text-lg font-medium leading-6 text-gray-900">Select your printer</h3>
					<p className="mt-2 max-w-4xl text-sm text-gray-500">This will determine the template used for printer.cfg</p>
				</div>
