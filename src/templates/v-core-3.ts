...
[stepper_z1]
dir_pin: !z1_dir_pin # Remove ! in front of pin name to reverse Z1 direction
rotation_distance: ${helper.getRail(PrinterAxis.z1).rotationDistance} # 4 for TR8*4 lead screws

[stepper_z2]
dir_pin: !z2_dir_pin # Remove ! in front of pin name to reverse Z2 direction
rotation_distance: ${helper.getRail(PrinterAxis.z2).rotationDistance} # 4 for TR8*4 lead screws
