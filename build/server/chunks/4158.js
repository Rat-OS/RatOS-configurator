"use strict";exports.id=4158,exports.ids=[4158],exports.modules={14158:(e,r,t)=>{t.d(r,{initialPrinterCfg:()=>initialPrinterCfg,template:()=>template});let template=(e,r)=>`
...
[include RatOS/printers/caramba/${e.size??300}.cfg]
...
${r.renderUserStepperSections({x:{directionInverted:!1,rotationComment:"40 for 20 tooth 2GT pulleys, 32 for 16 tooth 2GT pulleys",limits:r=>({min:0-r.min,max:(e.size??300)+r.max,endstop:0-r.min})},y:{directionInverted:!1,rotationComment:"40 for 20 tooth 2GT pulleys, 32 for 16 tooth 2GT pulleys",limits:r=>({min:0-r.min,max:(e.size??300)+r.max,endstop:(e.size??300)+r.max})},z:{directionInverted:!0,rotationComment:"4 for TR8*4 lead screws",limits:{min:0,max:e.size??300}},z1:{directionInverted:!0,rotationComment:"4 for TR8*4 lead screws"},z2:{directionInverted:!0,rotationComment:"4 for TR8*4 lead screws"},extruder:{directionInverted:!0,additionalLines:["#pressure_advance: 0.05 # Check https://www.klipper3d.org/Pressure_Advance.html for pressure advance tuning.","control: pid","pid_kp: 28.413","pid_ki: 1.334","pid_kd: 151.300"]}})}
