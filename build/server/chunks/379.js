...
__webpack_require__.d(__webpack_exports__, {
  "pM": () => (/* reexport */ fileTypeFromBuffer),
  "lb": () => (/* binding */ fileTypeFromFile)
});

// UNUSED EXPORTS: fileTypeFromStream, fileTypeFromTokenizer, fileTypeStream, supportedExtensions, supportedMimeTypes
 ...
 */
class EndOfFileStream_EndOfStreamError extends Error {
    constructor() {
...
const maxStreamReadSize = (/* unused pure expression or super */ null && (1 * 1024 * 1024)); // Maximum request length on read-stream operation
class StreamReader_StreamReader {
    constructor(s) {
        this.s = s;
        /**
 ...
 * Core tokenizer
 */
class AbstractTokenizer_AbstractTokenizer {
    ...
    async readToken(token, position = this.position) {
        ...
        if (len < token.len)
            throw new EndOfFileStream_EndOfStreamError();
...
class ReadStreamTokenizer_ReadStreamTokenizer extends (/* unused pure expression or super */ null && (AbstractTokenizer)) {
...
class BufferTokenizer extends AbstractTokenizer_AbstractTokenizer {
    /**
...
class FileTokenizer extends AbstractTokenizer_AbstractTokenizer {
...
var ieee754 = __webpack_require__(7716);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/file-type@17.1.6/node_modules/file-type/util.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/file-type@17.1.6/node_modules/file-type/supported.js
const extensions = [
	'jpg',
	'png',
	'apng',
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/file-type@17.1.6/node_modules/file-type/core.js
...
async function fileTypeFromTokenizer(tokenizer) {
	try {
		...
		if (!(error instanceof EndOfFileStream_EndOfStreamError)) {
			throw error;
		}
	}
}
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/file-type@17.1.6/node_modules/file-type/index.js
