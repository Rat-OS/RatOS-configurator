"use strict";exports.id=4613,exports.ids=[4613],exports.modules={84613:(e,r,t)=>{t.d(r,{initialPrinterCfg:()=>initialPrinterCfg,template:()=>template});let template=(e,r)=>`
...
[include RatOS/printers/voron-v24/${e.size??300}.cfg]
...
${r.renderUserStepperSections({x:{directionInverted:!0,rotationComment:"40 for 20 tooth 2GT pulleys, 32 for 16 tooth 2GT pulleys",limits:r=>({min:0-r.min,max:(e.size??300)+r.max,endstop:(e.size??300)+r.max})},y:{directionInverted:!1,rotationComment:"40 for 20 tooth 2GT pulleys, 32 for 16 tooth 2GT pulleys",limits:r=>({min:0-r.min,max:(e.size??300)+r.max,endstop:(e.size??300)+r.max})},z:{directionInverted:!0,limits:{min:0,max:(e.size??300)-40}},z1:{directionInverted:!0},z2:{directionInverted:!0},z3:{directionInverted:!0},extruder:{directionInverted:!0,additionalLines:["#pressure_advance: 0.05 # Check https://www.klipper3d.org/Pressure_Advance.html for pressure advance tuning.","control: pid","pid_kp: 21.673","pid_ki: 1.338","pid_kd: 87.776"]}})}
