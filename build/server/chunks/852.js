...
const useMoonraker = (hostname)=>{
    const { lastJsonMessage , sendJsonMessage , readyState  } = useWebSocket(`ws://${((hostname === null || hostname === void 0 ? void 0 : hostname.trim()) ?? '') != '' ? hostname : window.location.hostname}:7125/websocket`, {
