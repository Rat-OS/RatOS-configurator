...
async function handler(req, res) {
    ...
    return new Promise((resolve, reject)=>{
        (0,child_process__WEBPACK_IMPORTED_MODULE_0__.exec)(`sudo ${path__WEBPACK_IMPORTED_MODULE_1___default().join(scriptRoot, 'scripts/change-hostname.sh')} ${body.hostname}`, (err, stdout)=>{
            if (err) {
                console.log(err);
