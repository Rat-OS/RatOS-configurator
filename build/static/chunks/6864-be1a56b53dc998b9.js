(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[6864],{25497:function(e,t,a){"use strict";var n=a(85964),r=a(84568);/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */(0,n.jqO)("cpu",()=>new MathBackendCPU,1);var o=a(70967);/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let s=(0,o.A)(n.SX0,e=>e>=0?e:Math.exp(e)-1),i={kernelName:n.SX0,backendName:"cpu",kernelFunc:s};var u=a(38727);/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let c=(0,p.b)((e,t)=>e<0?t*e:e);function prelu(e){let{inputs:t,backend:a}=e,{x:n,alpha:l}=t;(0,r.H)([n,l],"prelu");let o=a.data.get(n.dataId).values,s=a.data.get(l.dataId).values,[i,u]=c(n.shape,l.shape,o,s,"float32");return a.makeTensorInfo(u,"float32",i)}let h={kernelName:n.o0g,backendName:"cpu",kernelFunc:prelu},f=(0,o.A)(n.qkr,e=>Math.max(0,e)),m={kernelName:n.qkr,backendName:"cpu",kernelFunc:f},k=(0,o.A)(n.SbG,e=>Math.min(Math.max(0,e),6)),g={kernelName:n.SbG,backendName:"cpu",kernelFunc:k};var I=a(15328);/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function(e){let{inputs:t,backend:a,attrs:n}=e,{x:r,weights:l}=t,{size:o}=n,s=a.data.get(r.dataId).values,i=a.data.get(l.dataId).values,u=(0,J.W)(s,i,l.dtype,l.shape,o);return a.makeTensorInfo([o],l.dtype,u)}};var et=a(82797);let ea={kernelName:n.eEB,backendName:"cpu",kernelFunc:/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function(e){let{inputs:t,backend:a}=e,{s0:r,s1:l}=t,o=a.data.get(r.dataId).values,s=a.data.get(l.dataId).values,i=n.backend_util.assertAndGetBroadcastShape(Array.from(o),Array.from(s));return a.makeTensorInfo([i.length],"int32",Int32Array.from(i))}};var en=a(61859),er=a(23001);/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function imag(e){let{inputs:t,backend:a}=e,{input:n}=t,r=a.data.get(n.dataId).complexTensorInfos.imag,l=a.data.get(r.dataId).values;return a.makeTensorInfo(r.shape,r.dtype,l)}let ed={kernelName:n.J_u,backendName:"cpu",kernelFunc:imag};var ep=a(63752);/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function(e){let{inputs:t,backend:a}=e,{dy:l,y:o}=t;(0,r.H)([l,o],"eluGrad");let s=new Float32Array(n.D5U.sizeFromShape(o.shape)),i=a.data.get(o.dataId).values,u=a.data.get(l.dataId).values;for(let e=0;e<i.length;++e){let t=i[e];t>=0?s[e]=u[e]:s[e]=u[e]*(t+1)}return a.makeTensorInfo(o.shape,"float32",s)}};var eV=a(16507);/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let eJ=(0,p.b)((e,t)=>e/t),e0=(0,R.j)(n.oHH,eJ),e1={kernelName:n.oHH,backendName:"cpu",kernelFunc:e0};var e2=a(65456);/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function fill(e){let{backend:t,attrs:a}=e,{shape:r,value:l,dtype:o}=a,s=o||n.D5U.inferDtype(l),i=n.D5U.getArrayFromDType(s,n.D5U.sizeFromShape(r));return function(e,t,a){e.fill(t)}(i,l,0),t.makeTensorInfo(r,s,i)}let e3={kernelName:n.deh,backendName:"cpu",kernelFunc:fill},e6={kernelName:n.Uyb,backendName:"cpu",kernelFunc:({inputs:e,attrs:t,backend:a})=>{let{image:r}=e,l=n.D5U.getTypedArrayFromDType(r.dtype,n.D5U.sizeFromShape(r.shape)),[o,s,i,u]=r.shape,d=a.data.get(r.dataId).values;for(let e=0;e<o;e++){let t=e*i*s*u;for(let e=0;e<s;e++){let a=e*(i*u);for(let e=0;e<i;e++){let n=e*u;for(let r=0;r<u;r++){let o=Math.round(i-e-1),s=t+a+n+r,p=d[s];if(o>=0&&o<i){let e=o*u,n=t+a+e+r;p=d[n]}l[s]=p}}}}let p=a.write(l,r.shape,r.dtype);return{dataId:p,shape:r.shape,dtype:r.dtype}}};var e4=a(6931);/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function(e){let{backend:t,attrs:a}=e,{start:n,stop:r,num:l}=a,o=(0,tg.b)(n,r,l);return t.makeTensorInfo([o.length],"float32",o)}};var ty=a(24158);/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let a2=(0,o.A)(n.h8e,(e,t)=>isNaN(e)?NaN:e>0?1:t.alpha),a5={kernelName:n.h8e,backendName:"cpu",kernelFunc:a2};var a3=a(89162);let a6={kernelName:n.jQk,backendName:"cpu",kernelFunc:/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function(e){let{inputs:t,backend:a,attrs:n}=e,{x:l}=t,{reps:o}=n;(0,r.H)(l,"tile");let s=(0,ns.R)(a.bufferSync(l),o);return a.makeTensorInfo(s.shape,s.dtype,s.values)}};var nu=a(29650);let nd={kernelName:n.cWu,backendName:"cpu",kernelFunc:/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */let r=(0,n.Z)("Play",[["polygon",{points:"6 3 20 12 6 21 6 3",key:"1oa8hb"}]])},43826:function(e,t,a){"use strict";a.d(t,{Z:function(){return r}});var n=a(24360);/**
 * @license lucide-react v0.363.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
