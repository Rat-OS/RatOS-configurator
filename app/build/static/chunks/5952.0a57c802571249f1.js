 ...
 * =============================================================================
 */let n={},o={alpha:!1,antialias:!1,premultipliedAlpha:!1,preserveDrawingBuffer:!1,depth:!1,stencil:!1,failIfMajorPerformanceCaveat:!0};function setWebGLContext(e,t){n[e]=t}},23066:function(e,t,r){r.d(t,{_:function(){return DecodeMatrixProgram}});var a=r(97918),n=r(11247),o=r(64127),i=r(84798);/**
 * @license
 ...
 */let DecodeMatrixProgram=class DecodeMatrixProgram{constructor(e){this.variableNames=["A"],this.packedInputs=!1,this.packedOutput=!0,this.outPackingScheme=i.m1.DENSE,this.customUniforms=[{name:"texShape",type:"ivec2"}];let t=(0,a.A)();this.outputShape=e,this.enableShapeUniforms=(0,n.C9)(this.outputShape.length),this.userCode=`
    ...
    `}}},47766:function(e,t,r){r.d(t,{G:function(){return DecodeMatrixPackedProgram}});var a=r(97918),n=r(11247),o=r(64127),i=r(84798);/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */let DecodeMatrixPackedProgram=class DecodeMatrixPackedProgram{constructor(e){this.variableNames=["A"],this.packedInputs=!0,this.packedOutput=!0,this.outPackingScheme=i.m1.DENSE,this.customUniforms=[{name:"texShape",type:"ivec2"}];let t=(0,a.A)();this.outputShape=e,this.enableShapeUniforms=(0,n.C9)(this.outputShape.length),this.userCode=`
    ...
    `}}},53296:function(e,t,r){r.d(t,{q:function(){return EncodeFloatProgram}});var a=r(97918),n=r(64127),o=r(84798);/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */let EncodeFloatProgram=class EncodeFloatProgram{constructor(e){this.variableNames=["A"],this.outTexUsage=o.v2.DOWNLOAD;let t=(0,a.A)();this.outputShape=e,this.userCode=`
    ...
    `}}},7594:function(e,t,r){r.d(t,{d:function(){return EncodeFloatPackedProgram}});var a=r(97918),n=r(64127),o=r(84798);/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */let EncodeFloatPackedProgram=class EncodeFloatPackedProgram{constructor(e){this.variableNames=["A"],this.packedInputs=!0,this.packedOutput=!1,this.outTexUsage=o.v2.DOWNLOAD;let t=(0,a.A)();this.outputShape=e,this.userCode=`
    ...
    `}}},9303:function(e,t,r){r.d(t,{F:function(){return EncodeMatrixProgram}});var a=r(97918),n=r(11247),o=r(64127);/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */let i={R:0,G:1,B:2,A:3};let EncodeMatrixProgram=class EncodeMatrixProgram{constructor(e,t=!1,r="RGBA"){this.variableNames=["A"],this.customUniforms=[{name:"texShape",type:"ivec2"}];let s=(0,a.A)();this.outputShape=e,this.enableShapeUniforms=(0,n.C9)(this.outputShape.length);let l="result";t&&(l="floor(result * 255. + 0.5)");let u="";for(let e=0;e<r.length;e++){let t=r[e];u+=`
    ...
    `}}},22758:function(e,t,r){r.d(t,{Z:function(){return EncodeMatrixPackedProgram}});var a=r(97918),n=r(11247),o=r(64127);/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */let EncodeMatrixPackedProgram=class EncodeMatrixPackedProgram{constructor(e,t=!1){this.variableNames=["A"],this.packedInputs=!1,this.packedOutput=!0,this.customUniforms=[{name:"texShape",type:"ivec2"}];let r=(0,a.A)();this.outputShape=e,this.enableShapeUniforms=(0,n.C9)(this.outputShape.length);let i="",s="result";t&&(s="floor(result * 255. + 0.5)");for(let t=0;t<=1;t++)for(let a=0;a<=1;a++){let n=2*t+a;i+=`
    ...
    `}}},91855:function(e,t,r){var a=r(81284),n=r(82358);/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */function getGlslDifferences(){let e,t,r,n,o,i,s,l,u,d;return 2===(0,a.OBj)().getNumber("WEBGL_VERSION")?(e="#version 300 es",t="in",r="out",n="in",o="texture",i="outputColor",s="out vec4 outputColor;",l=(0,a.OBj)().getBool("WEBGL2_ISNAN_CUSTOM")?`
    ...
    `),{version:e,attribute:t,varyingVs:r,varyingFs:n,texture2D:o,output:i,defineOutput:s,defineSpecialNaN:l,defineSpecialInf:u,defineRound:d}}},14730:function(e,t,r){r.d(t,{A:function(){return GPGPUContext}});var a=r(81284),n=r(43686),o=r(95366),i=r(84798),s=r(82358);/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */function forceHalfFloat(){(0,i.OBj)().set("WEBGL_FORCE_F16_TEXTURES",!0)}i.C2$.isBrowser()&&(0,i.jqO)("webgl",()=>new s.QC,2);let h={forceHalfFloat:forceHalfFloat};var f=r(11247);/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,$={kernelName:i.J$2,backendName:"webgl",kernelFunc:function(e){let{inputs:t,backend:r,attrs:a}=e,{x:n}=t,{alpha:o}=a,s=r.makeTensorInfo([],"float32",i.D5U.createScalarValue(o,"float32")),l=(0,i.OBj)().getBool("WEBGL_PACK_BINARY_OPERATIONS")?new BinaryOpPackedProgram(I,n.shape,s.shape):new BinaryOpProgram(y,n.shape,s.shape),u=r.runWebGLProgram(l,[n,s],"float32");return r.disposeIntermediateTensorInfo(s),u}},k="return (a < 0.) ? b * a : a;",R=`
  vec4 aLessThanZero = vec4(lessThan(a, vec4(0.)));
  return (aLessThanZero * (b * a)) + ((vec4(1.0) - aLessThanZero) * a);
`,T={kernelName:i.o0g,backendName:"webgl",kernelFunc:function(e){let{inputs:t,backend:r}=e,{x:a,alpha:n}=t,o=(0,i.OBj)().getBool("WEBGL_PACK_BINARY_OPERATIONS")?new BinaryOpPackedProgram(R,a.shape,n.shape):new BinaryOpProgram(k,a.shape,n.shape);return r.runWebGLProgram(o,[a,n],"float32")}};var w=r(31577),N=r(22129);/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */let DepthToSpaceProgram=class DepthToSpaceProgram{constructor(e,t,r){this.variableNames=["x"],this.outputShape=[],this.outputShape=e,this.blockSize=t,this.dataFormat=r,this.userCode=`
  ...
  `}getHeightCoordString(){return"NHWC"===this.dataFormat?"coords[1]":"coords[2]"}getWidthCoordString(){return"NHWC"===this.dataFormat?"coords[2]":"coords[3]"}getDepthCoordString(){return"NHWC"===this.dataFormat?"coords[3]":"coords[1]"}getOutputDepthSize(){return"NHWC"===this.dataFormat?this.outputShape[3]:this.outputShape[1]}getInputSamplingString(){return"NHWC"===this.dataFormat?"getX(b, in_h, in_w, in_d)":"getX(b, in_d, in_h, in_w)"}};let e8={kernelName:i.T0n,backendName:"webgl",kernelFunc:/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */let DepthwiseConv2DDerFilterProgram=class DepthwiseConv2DDerFilterProgram{constructor(e){this.variableNames=["x","dy"],this.outputShape=e.filterShape;let t=e.strideHeight,r=e.strideWidth,a=e.padInfo.top,n=e.padInfo.left,o=e.outChannels/e.inChannels;this.userCode=`
    ...
    `}};let e9={kernelName:i.sL$,backendName:"webgl",kernelFunc:/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,tS=`
  ...
  return vec4(result);
`,tF=binaryKernelFunc({opSnippet:tN,packedOpSnippet:tS,dtype:"int32"}),tE={kernelName:i.jeX,backendName:"webgl",kernelFunc:tF};var tA=r(84798);/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,t8=`
  ...
  return result;
`,t6=unaryKernelFunc({opSnippet:t5,packedOpSnippet:t8,cpuKernelImpl:E.Sd}),t9={kernelName:i.ZbH,backendName:"webgl",kernelFunc:t6},t7=S+`
  return log(1.0 + x);
...
`,r4=`
  ...
  `+C+`
  return result;
`,r3=binaryKernelFunc({opSnippet:r2,packedOpSnippet:r4}),r5={kernelName:i.pe_,backendName:"webgl",kernelFunc:r3},r8={kernelName:i.DlI,backendName:"webgl",kernelFunc:/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function(e){let{inputs:t,backend:r,attrs:a}=e,{paramsNestedSplits:n,paramsDenseValues:o,indices:i}=t,{outputRaggedRank:s}=a,l=n.map(e=>r.readSync(e.dataId)),u=n.map(e=>e.shape),d=r.readSync(o.dataId),c=r.readSync(i.dataId),[p,h,f]=(0,E.Qs)(l,u,d,o.shape,o.dtype,c,i.shape,s),m=p.map(e=>r.makeTensorInfo([e.length],"int32",e)),x=r.makeTensorInfo(f,o.dtype,h);return m.concat([x])}},r9={kernelName:i.CQl,backendName:"webgl",kernelFunc:/**
 * @license
 ...
 */let StridedSliceProgram=class StridedSliceProgram{constructor(e,t,r){this.variableNames=["x"],this.outputShape=r;let a=r.length,n=(0,g.kW)(r.length),o=(0,g.kW)(r.length),i="";if(1===a)i="coords * strides + begin";else{let e=0;i=r.map((t,a)=>(e++,1===r.length?`coords * strides[${a}] + begin[${a}]`:`coords[${e-1}] * strides[${a}] + begin[${a}]`)).join(",")}this.userCode=`
    ...
    `}};let a9={kernelName:i.jQk,backendName:"webgl",kernelFunc:/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */let{addImpl:n,bincountImpl:o,bincountReduceImpl:i,bitwiseAndImpl:s,castImpl:l,ceilImpl:u,concatImpl:d,equalImpl:c,expImpl:p,expm1Impl:h,floorImpl:f,gatherNdImpl:m,gatherV2Impl:x,greaterImpl:g,greaterEqualImpl:C,lessImpl:b,lessEqualImpl:v,linSpaceImpl:y,logImpl:I,maxImpl:$,maximumImpl:k,minimumImpl:R,multiplyImpl:T,negImpl:w,notEqualImpl:N,prodImpl:S,raggedGatherImpl:F,raggedRangeImpl:E,raggedTensorToTensorImpl:A,rangeImpl:O,rsqrtImpl:P,scatterImpl:_,sigmoidImpl:D,simpleAbsImpl:B,sliceImpl:L,sparseFillEmptyRowsImpl:V,sparseReshapeImpl:U,sparseSegmentReductionImpl:W,sqrtImpl:M,staticRegexReplaceImpl:G,stridedSliceImpl:z,stringNGramsImpl:X,stringSplitImpl:H,stringToHashBucketFastImpl:j,subImpl:K,tileImpl:Y,topKImpl:q,transposeImpl:Q,uniqueImpl:Z}=a},14739:function(e,t,r){r.d(t,{U:function(){return PackProgram}});var a=r(11247),n=r(14941),o=r(48334);/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */let PackProgram=class PackProgram{constructor(e){if(this.variableNames=["A"],this.packedInputs=!1,this.packedOutput=!0,this.outputShape=e,this.rank=e.length,this.enableShapeUniforms=(0,a.C9)(this.outputShape.length),0===this.rank)this.userCode=`
    ...
    `}getOutput(e){let t=this.getSourceCoordsArr(e);if(1===this.rank){let e=this.enableShapeUniforms?"outShape":this.outputShape[0];return`getA(rc), (rc + 1 >= ${e} ? 0. : getA(rc + 1)), 0, 0`}return`getA(${t[0]}),
            cEdge ? 0. : getA(${t[1]}),
            rEdge ? 0. : getA(${t[2]}),
            rEdge || cEdge ? 0. : getA(${t[3]})`}}},14941:function(e,t,r){/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,u=n+`
  return (x < 0.0) ? 0.0 : min(6.0, x);
`,d="return x;",c="return 1.0 / (1.0 + exp(-1.0 * x));"},22129:function(e,t,r){r.d(t,{Cv:function(){return o},RX:function(){return i},Tq:function(){return l},cc:function(){return UnaryOpPackedProgram},eW:function(){return s},t$:function(){return n}});var a=r(11247);/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,l="return 1.0 / (1.0 + exp(-1.0 * x));";let UnaryOpPackedProgram=class UnaryOpPackedProgram{constructor(e,t){this.variableNames=["A"],this.packedInputs=!0,this.packedOutput=!0,this.outputShape=e,this.enableShapeUniforms=(0,a.C9)(this.outputShape.length),this.userCode=`
    ...
    `}}},16581:function(e,t,r){r.d(t,{W:function(){return UnpackProgram}});var a=r(11247),n=r(14941),o=r(48334);/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
//# sourceMappingURL=5952.0a57c802571249f1.js.map